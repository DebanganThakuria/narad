...
type TopicRecord struct {
	...
	MaxInFlightPerPartition   int64  `gorm:"not null;default:0"`
	MaxAckedAheadPerPartition int64  `gorm:"not null;default:0"`
...
func (TopicRecord) FromTopic(t topic.Topic) TopicRecord {
	return TopicRecord{
		...
		MaxInFlightPerPartition:   t.MaxInFlightPerPartition,
		MaxAckedAheadPerPartition: t.MaxAckedAheadPerPartition,
...
func (r TopicRecord) ToTopic() topic.Topic {
	return topic.Topic{
		...
		MaxInFlightPerPartition:   r.MaxInFlightPerPartition,
		MaxAckedAheadPerPartition: r.MaxAckedAheadPerPartition,
