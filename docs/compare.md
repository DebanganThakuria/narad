...
| **Narad** | [50k msg/s sustained, full produce → consume → ack](operate/scaling-and-recovery.md#measured-capacity) | 3-node cluster | not claimed | fsync before ack, single copy, zstd |
